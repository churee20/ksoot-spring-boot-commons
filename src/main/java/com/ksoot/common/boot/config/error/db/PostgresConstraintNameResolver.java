...
package com.ksoot.common.boot.config.error.db;
...
public class PostgresConstraintNameResolver implements ConstraintNameResolver {
	 ...
	 *
	 * @see
	 * com.ksoot.framework.common.spring.config.error.dbconstraint.ConstraintNameResolver#
	 * resolveConstraintName(org.springframework.dao.DataIntegrityViolationException)
	 */
	@Override
	public String resolveConstraintName(DataIntegrityViolationException exception) {
